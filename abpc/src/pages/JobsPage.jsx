            ...
            {pickedService && (
              <div className="mt-2 flex items-center justify-between px-3 py-2.5 rounded-xl bg-[var(--brand-soft)] border border-emerald-200">
                <div>
                  ...
                  <p className="text-xs text-slate-500">{pickedService.quantity} {pickedService.unit} × ₹{pickedService.price}</p>
                </div>
                <div className="text-right">
                  <p className="font-black text-[var(--brand)]">₹{pickedService.total.toLocaleString("en-IN")}</p>
