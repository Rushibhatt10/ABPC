...
const premiumServicesData = [
  {
    ...
    points: [
      ...
      'Injection treatment for existing buildings',
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-5 md:px-14 relative z-10">
        <div className="mb-10 sm:mb-12 md:mb-20">
          <span
            style={{ fontFamily: "'DM Sans', sans-serif", letterSpacing: '0.28em' }}
            className="text-[#95B15F] text-[10px] font-medium uppercase block mb-4"
          >
            Our Services
          </span>

          <div
            className={`flex flex-col md:flex-row md:items-end justify-between gap-6 pb-7 border-b ${
              isDark ? 'border-white/8' : 'border-black/8'
            }`}
          >
            <h2
              style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300, letterSpacing: '-0.01em' }}
              className="text-[clamp(1.9rem,10vw,2.8rem)] md:text-6xl lg:text-7xl italic max-w-3xl leading-[1.05]"
            >
            ...
            <div className={`hidden md:flex items-center gap-3 pb-2 ${isDark ? 'text-white/30' : 'text-black/30'}`}>
              <span
