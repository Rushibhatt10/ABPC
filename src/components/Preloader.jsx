...
function SprayParticles({ visible }) {
 ...
 width: p.size,
 height: p.size,
 background: `radial-gradient(circle, rgba(255,255,255,0.9) 0%, rgba(52, 152, 219, 0.4) 100%)`,"--tx": p.tx,"--ty": p.ty,"--s": p.s,
...
export default function Preloader({ onComplete }) {
 ...
 >
 <div className="relative w-full max-w-4xl h-[min(62vh,400px)] flex items-center justify-center">
 {/* Bug / Target */}
 <div
 ...
 {/* Brand Identity */}
 <div
 className="absolute bottom-[calc(env(safe-area-inset-bottom)+2.5rem)] text-center transition-all duration-700 w-full px-5"
 style={{ 
 ...
 <span className="text-[7px] md:text-[9px] font-medium uppercase tracking-[0.6em] leading-none" style={{ color:"#F13A1D" }}>INSECTICIDE SERVICES</span>
 </div>
